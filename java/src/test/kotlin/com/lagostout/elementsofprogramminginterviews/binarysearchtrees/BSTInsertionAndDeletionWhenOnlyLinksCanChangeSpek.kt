...
object BSTInsertionAndDeletionWhenOnlyLinksCanChangeSpek : Spek({
    ...
    describe("insert") {
        ...
        on("tree: %s, valueToInsert: %s", with = *data) { root, valueToInsert, expected ->
            it("should return $expected") {
                BSTInsertionAndDeletionWhenOnlyLinksCanChange.insert(valueToInsert, root!!)
    ...
    describe("delete") {
        ...
        on("tree: %s, valueToDelete: %s", with = *data) { root, valueToDelete, expected ->
            it("should return $expected") {
                val tree = BSTInsertionAndDeletionWhenOnlyLinksCanChange
                        .delete(valueToDelete, root!!)
                println(tree)
