...
object ComputeBinaryTreeNodesInTopDownAlternatingLeftToRightOrderSpek: Spek({
    describe("computeBinaryTreeNodesInTopDownAlternatingLeftToRightOrder()") {
        val data = listOf(
                ...
                Pair(listOf(RBT(1, 2, null, 1),
                        ...
                        listOf(listOf(0), listOf(2,1), listOf(3,4), listOf(8,7,6,5))),
                Pair(listOf(RBT(1, 2, null, 1),
                        RBT(leftChildIndex = 3, value = 2),
                        RBT(rightChildIndex = 4, value = 3),
                        RBT(leftChildIndex = 5, rightChildIndex = 6, value = 4),
                        ...
                        listOf(listOf(0), listOf(2,1), listOf(3,4), listOf(8,7,6,5), listOf(9))),
                Pair(listOf(RBT(1, 2, null, 1),
                        RBT(leftChildIndex = 3, value = 2),
                        RBT(rightChildIndex = 4, value = 3),
                        RBT(leftChildIndex = 5, rightChildIndex = 6, value = 4),
                        ...
                        listOf(listOf(0), listOf(2,1), listOf(3,4),
                                listOf(8,7,6,5), listOf(9), listOf(11,10))),
                null
        ...
        on("root %s", with = *data) { root, expected ->
            it("returns $expected") {
                computeBinaryTreeNodesInTopDownAlternatingLeftToRightOrder(root).let {
